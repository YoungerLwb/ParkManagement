    ...
    <form id="form" class="form form-horizontal" method="post">
      <div class="row cl">
        ...
        <div class="formControls col-8">
          <input id="login-name" name="account" type="text" placeholder="账户" class="input-text size-L">
        </div>
      </div>
      <div class="row cl">
        <label class="form-label col-3"><i class="Hui-iconfont">&#xe60e;</i></label>
      ...
      <div class="row">
        <div class="formControls col-8 col-offset-3" style="letter-spacing:80px;">
...
<div class="footer">Copyright &nbsp; SWU @ LiuWenBo </div>
